      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="EditarR.php" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span
                  class="mr-2 icon-paper-plane"></span>Editar Reservacion</a>
            <a href="EliminarR.php" class="btn btn-danger border-width-2 d-none d-lg-inline-block"><span
            class="mr-2 icon-paper-plane"></span>Cancelar Reservacion</a>
            </div>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Consultar Reservación</h1>
            </div>
            <form method="GET" class="search-jobs-form">


            <?php
        if(isset($_GET['idReservacionB'])){
            $client = new SoapClient("http://54.162.111.41:8080/Hotel.wsdl");
        
            $parametros = array("idReservacion"=> $_GET['idReservacionB']);
            $response = $client->__soapCall('MostrarReservacion',array($parametros),);
            print"<h2>".$response->{'fechaLlegada'}. ' '.$response->{'fechaSalida'}.' '.$response->{'NumAdultos'}.
            ' '.$response->{'NumNinos'}. ' '.$response->{'tipoHabitacion'}. ' '.$response->{'nombreCliente'}.' '.$response->{'telefono'}.' '.$response->{'idCliente'}."</h2>";
        }
    ?>
            
                <div class="container-fluid">
                    <h1 class="mt-4"> Reservación</h1>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <label> </label>
                  <p></p>
                  <button type="submit" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Consultar Reservacion</button>
                </div> 
            </form>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <label> </label>
