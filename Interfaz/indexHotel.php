        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Agencia HotelGJ</h1>
              <p>Encuentra tu hotel ideal con los mejores descuentos.</p>
            </div>
            ...
            $parametros = array("fechaLlegada"=>$fechaLlegada , "fechaSalida"=>$fechaSalida , "NumAdultos"=>$NumAdultos,"NumNinos"=>$NumNinos , "tipoHabitacion"=>$tipoHabitacion , "nombreCliente"=>$nombreCliente,"telefono"=>$telefono , "idCliente"=>$idCliente );
              ...
              <div class="row mb-5">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  ...
                  <select id="habitacion" name="habitacion" class="form-control">
                    ...
                    <option value="Suite Estudio">Suite Estudio</option> 
                  </select>
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <p>Nombre Cliente</p>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                  <label> </label>
                  <p></p>
                  <button type="submit" class="btn btn-primary btn-lg btn-block text-white btn-search"><span class="icon-search icon mr-2"></span>Reservar</button>
                </div>
              </div>
            </form>
          </div>
